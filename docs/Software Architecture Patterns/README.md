...
- [What are the essential skills for Microservices developers?](https://blog.softwaremill.com/what-are-the-essential-skills-for-microservices-developers-a3db7d0149f4)
...
### Courses:
- [Microservices: The Big Picture | Pluralsight](https://app.pluralsight.com/library/courses/microservices-big-picture/table-of-contents)
- [Microservices: Getting Started | Pluralsight](https://app.pluralsight.com/library/courses/getting-started-microservices/table-of-contents)
- [Microservices: Fundamentals | Pluralsight](https://app.pluralsight.com/library/courses/microservices-fundamentals/table-of-contents)
- [Building Microservices | Pluralsight](https://app.pluralsight.com/library/courses/building-microservices/table-of-contents)
- [Building Reactive Microservices | Pluralsight](https://app.pluralsight.com/library/courses/building-reactive-microservices/table-of-contents)
- [Microservices: DevOps | Pluralsight](https://app.pluralsight.com/library/courses/microservices-devops/table-of-contents)
- [Microservices Transition | Pluralsight](https://app.pluralsight.com/library/courses/your-microservices-transition/table-of-contents)
- [Scoping and Organizing .NET Microservices Using Event Storming | Pluralsight](https://app.pluralsight.com/library/courses/dotnet-microservices-scoping-organizing/table-of-contents)
